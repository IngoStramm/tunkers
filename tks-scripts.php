...
function tks_enqueue_scripts()
{
    ...
    wp_register_script('tks-script', TKS_URL . 'assets/js/tunkers' . $min . '.js', array('jquery'), '1.0.1', true);
    wp_enqueue_script('tks-script');
    wp_localize_script('tks-script', 'ajax_object', array('ajax_url' => admin_url('admin-ajax.php')));

    wp_enqueue_style('tks-style', TKS_URL . '/assets/css/tunkers.css', array(), '1.0.1');
}
